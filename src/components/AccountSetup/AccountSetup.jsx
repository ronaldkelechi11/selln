    ...
    return (
        <div
            ...
            <div className="w-full h-full flex flex-col justify-center items-center gap-2 md:w-[50%]">
                <div className="text-4xl md:text-7xl text-white md:text-primary font-billabong text-center">Account Setup</div>
                ...
                <form className="w-full flex gap-5 flex-col" onSubmit={accountSetup}>
                    ...
                    <motion.input
                        ...
                        className="bg-white rounded-lg p-[10px_20px] text-xl font-billabong text-primary md:bg-primary md:text-white cursor-pointer" type="submit" value="Done" />
                </form>
